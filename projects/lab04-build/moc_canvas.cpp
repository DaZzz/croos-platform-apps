...
QT_MOC_LITERAL(4, 26, 10)
    ...
    "Canvas\0setNewImage\0\0image\0applySchar"
};
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setNewImage((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        case 1: _t->applySchar(); break;
        default: ;
        }
    }
}
